...
const Community = () => {
  return (
    <div className="flex flex-col items-center gap-12 xl:gap-16 pt-16 lg:pt-6 py-8 px-4
    text-very-dark-cyan font-popines 
    md:px-8 lg:px-12 xl:px-20">

      <section className='flex flex-col items-center gap-8 lg:gap-10 xl:gap-14 text-center'>

        <h1 className="text-2xl lg:text-3xl xl:text-5xl font-bold ">Build The Community Your Fans Will Love</h1>
        <p className="font-open lg:text-lg xl:text-xl lg:px-20 xl:px-[30rem]">
